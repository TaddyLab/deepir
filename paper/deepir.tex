...
inversion-based classification rule.  Finally, inversion adds a
...
consideration as a simple default in document classification.
...
the $S \times C$ matrix of sentence probabilites,
...
% As recommended
% in the documentation, we apply repeated SGD over 20 re-orderings of each
...
DM+DBOW representation, to  separate maximum
likelihood logistic regressions. 

\vskip .1cm
\noindent \textit{MNIR}, the multinomial inverse regression of Taddy
\shortcite{taddy_multinomial_2013,taddy_distributed_2014}, %taddy_measuring_2013
...
class-space. Here, we regress word counts onto stars expressed 
...
for each document.  These statistics are then input to maximum
likelihood logistic regressions.
...
\shortcite{taddy_distributed_2014}.
