...
Use $\mathbf{w} = [w_1\dots w_T]'$ to denote a sentence: an ordered vector of word identities.
The skip-gram  in
(\ref{eq:skipgram}) yields the pairwise composite likelihood\footnote{See  Molenberghs and Verbeke  \shortcite{molenberghs2006models} for  similar pairwise compositions in analysis of longitudinal data.}
...
\{\mathbf{w}_1, ... \mathbf{w}_S\}$ has  likelihood 
