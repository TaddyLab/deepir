...
Given the success of such representations,  researchers have proposed
...
A popular example is the word2vec machinery.  This 
trains the distributed representation to be useful as an input layer for prediction of
words from their neighbors in a Skipgram likelihood.
