...
png(file="graphs/yelp_logistic.png", width=6,height=3, units="in", res=720)
plot(logitcoarse)
invisible(dev.off())
...
pdf("graphs/nnpprob.pdf", width=9, height=2.75)
par(mfrow=c(1,3),mai=c(.45,.45,.3,.2),omi=c(.15,.15,0,0))
...
pdf("graphs/fineprob.pdf", width=9, height=2.75)
par(mfrow=c(1,3),mai=c(.45,.45,.3,.2),omi=c(.15,.15,0,0))
